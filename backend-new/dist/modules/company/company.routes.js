...
router.post('/', (0, validationMiddleware_1.validate)(company_schema_1.createCompanySchema), companyController.create);
router.put('/:id', (0, validationMiddleware_1.validate)(company_schema_1.updateCompanySchema), companyController.update);

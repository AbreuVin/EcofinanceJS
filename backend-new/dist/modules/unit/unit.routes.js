...
router.post('/', (0, validationMiddleware_1.validate)(unit_schema_1.createUnitSchema), unitController.create);
router.put('/:id', (0, validationMiddleware_1.validate)(unit_schema_1.updateUnitSchema), unitController.update);

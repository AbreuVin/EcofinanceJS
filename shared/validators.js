...
export const validationSchemas = {
    ...
    emissoes_fugitivas: {
        ...
        // A lógica do 'get' é importante, mas a validação será feita na função abaixo.
        get validOptions() {
            return {
                periodo: ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro", "Anual"],
        ...
        // Função de validação com a lógica condicional
        validateRow: function(rowData, optionsCache) {
            const errors = {};
            // Usa as opções do cache (vindas da API) se disponíveis, senão usa as locais como fallback.
            const validOptions = {
                ...this.validOptions,
            ...
            // Lógica Condicional para Gás Puro vs. Gás Composto
            ...
            if (isCompositionStarted) {
                // Se for um gás composto, os campos de composição são obrigatórios.
                ...
                // 'tipo_gas' (puro) não é obrigatório neste caso.
            } else {
                // Se NÃO for um gás composto, então o 'tipo_gas' (puro) é obrigatório.

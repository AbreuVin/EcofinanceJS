...
function Form(props) {
	...
	const submit = async (event) => {
		...
		if (hasError && props.control) {
			props.control._subjects.state.next({ isSubmitSuccessful: false });
...
//#endregion
export { Watch as a, get as c, useFieldArray as d, useForm as f, useWatch as h, FormStateSubscribe as i, set as l, useFormState as m, Form as n, appendErrors as o, useFormContext as p, FormProvider as r, createFormControl as s, Controller as t, useController as u };
//# sourceMappingURL=index.esm-Cyoa-b3o.js.map